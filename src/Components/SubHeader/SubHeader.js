...
const SubHeader = () => {
  ...
  return (
      <Container style={{ marginTop: theme.spacing(3.5), marginBottom: theme.spacing(3.5) }}>
        <Container id="banner">
          <Box display='flex' flexWrap="wrap" justifyContent='space-around' padding={theme.spacing(3, 0)}>
            <Box display='flex' justifyContent='flex-start' alignItems="flex-start" width='300px' margin={theme.spacing(0.25)}>
